        ...
        <div className="flex flex-row justify-between items-center h-16 bg-white text-black relative shadow-sm font-mono">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="group relative">
                    <img src={assets.profile_icon} className="w-5 cursor-pointer" alt="cart icon" />
                    <div className="group-hover:block hidden absolute dropdown-menu top-0 right-0 pt-4 ">
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full h-screen' : 'w-0'}`}>
                <div className="flex flex-col text-gray-600">
                    <div onClick={()=>setVisible(false)} className="flex items-center gap-4 p-3 cursor-pointer">
                        <img src={assets.dropdown_icon} className="h-4" alt="dropdown icon"/>
                        <p>Back</p>
                    </div>
